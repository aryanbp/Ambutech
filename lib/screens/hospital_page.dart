...
class HospitalPage extends StatefulWidget {
  ...
  const HospitalPage(this.email, this.lst, {Key? key}) : super(key: key);

  @override
  _HospitalPageState createState() => _HospitalPageState(email,lst);
}

class _HospitalPageState extends State<HospitalPage> {
  final String email;
  final List<Widget> lst;
  _HospitalPageState(this.email,this.lst);
